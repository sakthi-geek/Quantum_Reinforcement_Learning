...
def main():
    ...
    #
    # outcome_files = filter_files_with_subdir_levels(base_dir, subdirs_with_levels, substring, extension)
    ...
    selection_type = "Quantum N Layer"     # Quantum vs Classical, Quantum N Layer
    ...
    if selection_type == "Quantum vs Classical":
    ...
    elif selection_type == "Quantum N Layer":
        if rl_agent == "Policy_Gradient_REINFORCE":
    ...
    helper.plot_multiple_experiments(multi_exp_reward_histories, select_experiment_ids, experiment_names, save=False,
                        plot_title=f"{rl_agent} - {selection_type} experiments - averaged rewards")
    ...
    # helper.calculate_comparitive_metrics(multi_exp_reward_histories, select_experiment_ids, experiment_names, save=True)
    #-------------------------------------------------------------------------------------
    ...
    filtered_files = filter_files_with_subdir_levels(base_dir, subdirs_with_levels, substring, extension)
    ...
    helper.write_to_csv(filtered_files, output_csv_file, special_fields=special_fields, sort_keys=sort_keys, ignore_keys=ignore_keys)
